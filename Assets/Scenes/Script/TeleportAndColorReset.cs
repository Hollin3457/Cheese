...
public class TeleportAndColorReset : MonoBehaviour
{
    ...
    public float temporaryMassMultiplier = 1000f;  // Set the multiplier for temporary mass increase
    ...
    void Start()
    {
        ...
        {
            Debug.LogError("CheeseOk object not assigned for teleportation.");
        }
        else
        {
            ...
            {
                Debug.LogError("Rigidbody component not found on CheeseOk object.");
            }
        }
    }
